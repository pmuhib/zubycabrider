...
public class UpdateRiderDataPresenter {
    private ResultInterface mResultInterface;
    private Context mContext;
    private final String TAG = UpdateRiderDataPresenter.class.getSimpleName();
            ...
            try {
                try {
                    ...
                    Request request = new Request.Builder()
                            .url(ApiKeys.RIDER_BASE_URL + "updateRiderDetails")
                            .post(body)
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (type.equalsIgnoreCase("success")) {
                    UpdateRiderDataModel updateRiderDataModel = new UpdateRiderDataModel();
